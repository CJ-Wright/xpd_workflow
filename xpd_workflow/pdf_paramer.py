...
def opt_qmax(q, iq, params, min_qmax=25, resolution=.1, window=3,
    ...
    for i in range(len(a)):
        ...
        for j in range(i, len(a)):
            ...
            ripple_array[i, j] = np.sum(np.abs(w))
...
#             '/media/christopher/5TB_Backup/deepthought/bulk-data/research_data'
#             '/USC_beamtime/APS_March_2016/S1/temp_exp/{}.chi'.format(
#                 str(k).zfill(5)),
#             unpack=True)
#         # fg_x, bg_subed_y = loadData(
#         # '/media/christopher/5TB_Backup/deepthought/bulk-data/research_data
#         # /USC_beamtime/APS_March_2016/S1/temp_exp/d25_S6_VT-00000.chi',
#         # unpack=True)
#         # fg_x /= 10
#         pd = {'qmin': 1.5,
#               'qmax': 26., 'qmaxinst': 35.,
...
#         # plt.imshow(ripple_array, cmap='viridis', interpolation='none', extent=[
#         # a[0], a[-1], a[0], a[-1]], origin='lower left',
